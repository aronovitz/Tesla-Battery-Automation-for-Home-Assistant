...
* As a result of the above, my automation logic is different for winter and summer (which I defined based on past low solar generation/higher consumption and high solar generation/medium consumpiton periods, respectively.)
